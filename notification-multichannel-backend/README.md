...
Isso irá iniciar:
- **MySQL** na porta `3307` no host (`3306` dentro do container)
...
Credenciais do MySQL usadas pela aplicação:
- Banco: `notification_multichannel`
- Usuário: `notification_user`
- Senha: `notification_password`
- URL JDBC: `jdbc:mysql://localhost:3307/notification_multichannel`
